...
void LCD_Initialization(void)
{
	...
	//printf("Device_code: %d", DeviceCode);
	/* 不同屏驱动IC 初始化不同 */
//	if( DeviceCode == 0x9325 || DeviceCode == 0x9328 )	 //USE THIS FOR LAB BOARD
//	{
//		LCD_Code = ILI9325;
...
//	}
//	else 
	if( DeviceCode == 0x9320 || DeviceCode == 0x9300 ) //USE THIS FOR PERSONAL BOARD
	{
	    LCD_Code = ILI9320;
